...
class Splitter:
    ...
    def __init__(self, tensors: List[tf.Tensor], cluster_indexes: tf.Tensor, n_splits, seed, train_sampling=1.0,
                 test_sampling=1.0):
        # tensors[0] is the actual dataframe. Its shape[0] is the num of rows.
...
class InputPipe:
    ...
    def make_features(self, x_hits, y_hits, dow, lagged_hits, pf_agent, pf_country, pf_site, page_ix,
                      page_popularity, median_7, median_30, median_90, median_180, year_autocorr, quarter_autocorr):
        """
        ...
        stacked_features = tf.stack([page_popularity, median_7, median_30, median_90, median_180, quarter_autocorr, year_autocorr])
...
def page_features(inp: VarFeeder):
    return (inp.hits, inp.pf_agent, inp.pf_country, inp.pf_site,
            inp.page_ix, inp.page_popularity, inp.median_7, inp.median_30, inp.median_90, inp.median_180, inp.year_autocorr, inp.quarter_autocorr)
